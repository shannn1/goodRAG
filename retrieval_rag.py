...
class RagRetriever:
    ...
    def from_pretrained(cls, retriever_name_or_path, indexed_dataset=None, **kwargs):
        ...
        index = indexed_dataset or cls._build_index(config)
    ...
    def postprocess_docs(self, docs, input_strings, prefix, n_docs, return_tensors=None):
        rag_input_strings = [
            f"{prefix or ''}{doc['title']}{self.config.title_sep}{doc['text']}{self.config.doc_sep}{input_string}".replace("  ", " ")
            for doc, input_string in zip(docs, input_strings)
